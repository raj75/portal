                ...
                if ( isset( $column['formatter'] ) ) {
                   // $row[ $column['dt'] ] = ($isJoin) ? $column['formatter']( $data[$i][ $column['field'] ], $data[$i] ) : $column['formatter']( $data[$i][ $column['db'] ], $data[$i] );
					...
					if($isJoin and $column['dt'] != "DT_RowId"){
						...
						if(isset($_SESSION["group_id"]) and ($_SESSION["group_id"] == 1 or $_SESSION["group_id"] == 2) and $column['field']=="SiteActiveDate" ){
							...
							*/
							...
							if ($column['field'] == 'SiteNumber') {
								$tempp='<a href="javascript:void(0);" onclick="load_details(\''.$data[$i][0].'\',\''.$data[$i][9].'\')"> '.$column['formatter']( $data[$i][ $column['field'] ], $data[$i] ).'</a> ';

							}elseif ($column['field'] == 'SiteStatus') {
								$tempp=$column['formatter']( $data[$i][ $column['field'] ], $data[$i] );
								$tempp=(($tempp==1 or is_null($tempp) or $tempp=="Active")?"Active":"Inactive");
