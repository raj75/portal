                   ...
                   // $row[ $column['dt'] ] = ($isJoin) ? $column['formatter']( $data[$i][ $column['field'] ], $data[$i] ) : $column['formatter']( $data[$i][ $column['db'] ], $data[$i] );
					...
					if($isJoin){
						if(isset($_SESSION["group_id"]) and ($_SESSION["group_id"] == 1 or $_SESSION["group_id"] == 2) and $column['field']=="active_date" ){	
							...
							if(isset($_SESSION["group_id"]) and ($_SESSION["group_id"] == 1 or $_SESSION["group_id"] == 2)){$tempp=$tempp.' onmouseover="showversion(\''.addslashes($data[$i][0]).'\',\''.trim($column['dbnam']).'\',\''.$column['field'].'\',\''.$ts.'\',\'vendor-pedit\',\'assets/ajax/vendor-pedit.php?load=true\')" id="'.$ts.'" class="showversion-link"';}
						...
						$tempp='<a href="javascript:void(0);"';
						$tempp=$tempp.' onmouseover="showversion(\''.addslashes($data[$i][0]).'\',\''.trim($column['dbnam']).'\',\''.$column['field'].'\',\''.$ts.'\',\'vendor-pedit\',\'assets/ajax/vendor-pedit.php?load=true\')" id="'.$ts.'" class="showversion-link"';
						$tempp=$tempp.' onclick="veload_details(\''.$data[$i][0].'\')"> '.$column['formatter']( $data[$i][ $column['field'] ], $data[$i] ).'</a>';
