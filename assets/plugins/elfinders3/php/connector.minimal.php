...
$temp_foldername=$temp_path="";
$temp_dfolder_arr=$temp_cfolder_arr=array();
...
//!!!!!!!!!!!!!!AWS CONFIG HERE!!!!!!!!!!!!!!!
$aws_config = [
    "key" => "AKIAIDRTDHNTGQ4TLMYA",
    "secret" => "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",
    "region" => "us-west-2",
    "bucket" => "datahub360"
];
...
$opts = array(
	...
	'roots' => [
        ...
        [
            'driver' => 'Flysystem',
            'alias' => 'Home',//Change to anything you like
