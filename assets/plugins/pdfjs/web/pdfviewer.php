...
if(isset($_GET) and isset($_GET["file"]) and !empty(@trim($_GET["file"])) and isset($_GET["fname"]) and !empty(@trim($_GET["fname"]))){
  $ourl=$_GET["file"]=@trim(urldecode($_GET["file"]));
          ...
          <div id="toolbarContainer">
            <div id="toolbarViewer">
              ...
              <div id="toolbarViewerRight">
                ...
                <button id="downloads" class="toolbarButton download hiddenMediumView" title="Download" tabindex="34" data-l10n-id="download" onclick="downloads('<?php echo $ourl; ?>')">
                  <span data-l10n-id="download_label">Download</span>
                </button>
