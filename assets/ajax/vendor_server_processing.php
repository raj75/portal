...
if(isset($_SESSION["group_id"]) and isset($_SESSION['user_id'])){
	$columns = array(
		array( 'db' => '`vendor_id`',     'dt' => 0,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'vendor_id', 'dbnam' => 'vendor' ),
		array( 'db' => '`vendor_name`',     'dt' => 1,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'vendor_name', 'dbnam' => 'vendor' ),
		array( 'db' => '`capturis_vendor_name`',     'dt' => 2,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'capturis_vendor_name', 'dbnam' => 'vendor' ),
		array( 'db' => '`service_group`', 'dt' => 3,  'formatter' => function( $d, $row ) {return $d;},'field' => 'service_group', 'dbnam' => 'vendor' ),
		array( 'db' => '`deregulated`', 'dt' => 4,  'formatter' => function( $d, $row ) {return $d;},'field' => 'deregulated', 'dbnam' => 'vendor' ),
		array( 'db' => '`vendorCity`',     'dt' => 5,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'vendorCity', 'dbnam' => 'vendor' ),
		array( 'db' => '`vendorState`',     'dt' => 6,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'vendorState', 'dbnam' => 'vendor' ),
		array( 'db' => '`vendorZip`',     'dt' => 7,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'vendorZip', 'dbnam' => 'vendor' ),
		array( 'db' => '`vendorCountry`',     'dt' => 8,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'vendorCountry', 'dbnam' => 'vendor' ),
		array( 'db' => '`importDate`',     'dt' => 9,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'importDate', 'dbnam' => 'vendor' )
	);
	if(isset($_SESSION["group_id"]) and ($_SESSION["group_id"] == 1 or $_SESSION["group_id"] == 2) and isset($_SESSION['user_id'])){
		//array_push($columns,array( 'db' => '`deregulated`',     'dt' => 5,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'deregulated', 'dbnam' => 'vendor' ));
	}
...
require('../includes/vendorssp.inc.php' );

$joinQuery = "FROM vendor";
$extraWhere = "";
$groupBy = "";
$having = "";
