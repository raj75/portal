...
if(isset($_SESSION["group_id"]) and isset($_SESSION['user_id'])){
	$columns = array(
		array( 'db' => '`ID`',     'dt' => 0,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'ID', 'dbnam' => 'line_item_tou' ),
		array( 'db' => '`service_group_id`',     'dt' => 1,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'service_group_id', 'dbnam' => 'line_item_tou' ),
		array( 'db' => '`service_group`',     'dt' => 2,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'service_group', 'dbnam' => 'line_item_tou' ),
		array( 'db' => '`line_item_description`', 'dt' => 3,  'formatter' => function( $d, $row ) {return $d;},'field' => 'line_item_description', 'dbnam' => 'line_item_tou' ),
		array( 'db' => '`TOU`',     'dt' => 4,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'TOU', 'dbnam' => 'line_item_tou' ),
		array( 'db' => '`Type`',     'dt' => 5,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'Type', 'dbnam' => 'line_item_tou' ),
		array( 'db' => '`Season`',     'dt' => 6,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'Season', 'dbnam' => 'line_item_tou' ),
		array( 'db' => '`Demand`',     'dt' => 7,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'Demand', 'dbnam' => 'line_item_tou' ),
		array( 'db' => '`Reactive`',     'dt' => 8,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'Reactive', 'dbnam' => 'line_item_tou' ),
		array( 'db' => '`PFactor`',     'dt' => 9,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'PFactor', 'dbnam' => 'line_item_tou' ),
		array( 'db' => '`Billed`',     'dt' => 10,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'Billed', 'dbnam' => 'line_item_tou' ),
		array( 'db' => '`Losses`',     'dt' => 11,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'Losses', 'dbnam' => 'line_item_tou' ),
		array( 'db' => '`Coincident`',     'dt' => 12,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'Coincident', 'dbnam' => 'line_item_tou' ),
		array( 'db' => '`Bundled`',     'dt' => 13,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'Bundled', 'dbnam' => 'line_item_tou' ),
		array( 'db' => '`importDate`',     'dt' => 14,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'importDate', 'dbnam' => 'line_item_tou' )
	);
...
$db_name 		= 'vervantis';
$db_host 		= 'develop.cfiddgkrbkvm.us-west-2.rds.amazonaws.com';
$sql_details = array(
	'user' => $db_username,
	'pass' => $db_password,
	'db'   => $db_name,
...
require('../includes/ssp_vendor.inc.php' );

$joinQuery = "FROM line_item_tou";
$extraWhere = "";
$groupBy = "";
$having = "";
