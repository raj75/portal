					...
					success: function (result) {
						if (result != false)
						{
							...
							if(results.error == "")
							{
								...
								$("#edit-account-message").remove();
								parent.$("#load-sdetails").html('<iframe src="assets/ajax/detailstesting.php?id=<?php echo $Sites_Id; ?>" style="width:100%;height:383px" frameBorder="0" scrolling="no"></iframe>');
					...
					success: function (result) {
						if (result != false)
						{
							...
							if(results.error == "")
							{
								...
								parent.$("#response").html('');
								$("#add-account-message").remove();
								parent.$("#load-sdetails").html('<iframe src="assets/ajax/detailstesting.php?id=<?php echo $Id; ?>" style="width:100%;height:383px" frameBorder="0" scrolling="no"></iframe>');
								//parent.$('#list-sites').load('assets/ajax/list-sites.php?load=true');								
							}else
								alert(results.error);
						}else{
