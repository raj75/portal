...
$_COOKIE["docname"] = "Supply Chain Solutions";
...
<section id="widget-grid" class="">
	...
	?>
				...
				<?php
					...
					{
						?><iframe src="assets/plugins/cute-file-browsers/index.php?id=<?php echo rand(1,1000); ?>&docname=Supply Chain Solutions" frameborder="0" width="100%" height="100%" id="frame1"></iframe><?php
					}
				?>
				</div>
				<!-- end widget div -->
