...
if(checkpermission($mysqli,62)==false) die("Permission Denied! Please contact Vervantis.");


$user_one=$_SESSION['user_id'];
$cname=$_SESSION['company_id'];

$_COOKIE["docname"] = "Energy Accounting:Exception Reports";
$_SESSION["docname"] = "Energy Accounting:Exception Reports";
	...
	<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
		<h1 class="page-title txt-color-blueDark">
			<i class="glyphicon glyphicon-stats "></i>
				Energy Accounting <span>> Exception Reports</span>
		</h1>
	</div>
</div>
<script>
