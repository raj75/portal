...
$_COOKIE["docname"] == "Market Resources";
...
<section id="widget-grid" class="">
	...
	?>
				...
				<?php
					...
					{
						?><iframe src="assets/plugins/cute-file-browsers/index.php?id=<?php echo rand(1,1000); ?>&docname=Market Resources" frameborder="0" width="100%" height="100%" id="frame1"></iframe><?php
					}
				?>
				</div>
				<!-- end widget div -->
