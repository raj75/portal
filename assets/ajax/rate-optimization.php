...
if(checkpermission($mysqli,41)==false) die("Permission Denied! Please contact Vervantis.");

$user_one=$_SESSION['user_id'];
$cname=$_SESSION['company_id'];

$_COOKIE["docname"] = "Rate Optimization:Utility Rate Reports";
$_SESSION["docname"] = "Rate Optimization:Utility Rate Reports";
	...
	<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
		<h1 class="page-title txt-color-blueDark">
			<i class="glyphicon glyphicon-stats "></i>
				Rate Optimization <span>> Utility Rate Reports</span>
		</h1>
	</div>
</div>
<script>
