...
if(isset($_SESSION["group_id"]) and isset($_SESSION['user_id'])){
	$columns = array(
		array( 'db' => '`ID`',     'dt' => 0,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'ID', 'dbnam' => 'accounts' ),
		array( 'db' => '`invoice_source`',     'dt' => 1,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'invoice_source', 'dbnam' => 'accounts' ),
		array( 'db' => '`company_id`',     'dt' => 2,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'company_id', 'dbnam' => 'accounts' ),
		array( 'db' => '`site_number`', 'dt' => 3,  'formatter' => function( $d, $row ) {return $d;},'field' => 'site_number', 'dbnam' => 'accounts' ),
		array( 'db' => '`site_inactive_date`',     'dt' => 4,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'site_inactive_date', 'dbnam' => 'accounts' ),
		array( 'db' => '`vendor_name`',     'dt' => 5,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'vendor_name', 'dbnam' => 'accounts' ),
		array( 'db' => '`service_group`',     'dt' => 6,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'service_group', 'dbnam' => 'accounts' ),
		array( 'db' => '`account_number1`',     'dt' => 7,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'account_number1', 'dbnam' => 'accounts' ),
		array( 'db' => '`importDate`',     'dt' => 8,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'importDate', 'dbnam' => 'accounts' )
	);
	if(isset($_SESSION["group_id"]) and ($_SESSION["group_id"] == 1 or $_SESSION["group_id"] == 2) and isset($_SESSION['user_id'])){
		//array_push($columns,array( 'db' => '`deregulated`',     'dt' => 5,  'formatter' => function( $d, $row ) {return $d;}, 'field' => 'deregulated', 'dbnam' => 'accounts' ));
	}
...
require('../includes/ssp_accounts.inc.php' );

$joinQuery = "FROM accounts";
$extraWhere = "";
$groupBy = "";
$having = "";
