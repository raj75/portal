	...
	<div class="row ssse" id="<?php echo $veid; ?>">
		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id--77" data-widget-editbutton="false">
				...
				if ($vestmt = $mysqli->prepare('Select 	vendor_id,capturis_vendor_id,vendor_name,capturis_vendor_name,vendor_abbreviation,vendor_altname1,vendor_altname2,vendor_altname3,vendor_altname4,vendor_altname5,service_group,service_group_id,deregulated,vendor_type,state,vendorAddr1,vendorAddr2,vendorCity,vendorState,vendorZip,vendorCountry,vendorPhoneNbr1,vendorPhoneNbr2,vendorPhoneNbr3,vendorFaxNbr1,vendorFaxNbr2,vendorEmail1,VendorEmail2,vendorWebpage1,vendorWebpage2,importDate From vendor Where vendor_id='.$veid.' LIMIT 1')) {

				$vestmt->execute();
				$vestmt->store_result();
				if ($vestmt->num_rows > 0) {
					$vestmt->bind_result($veid,$capturis_vendor_id,$vendor_name,$capturis_vendor_name,$vendor_abbreviation,$vendor_altname1,$vendor_altname2,$vendor_altname3,$vendor_altname4,$vendor_altname5,$service_group,$service_group_id,$deregulated,$vendor_type,$state,$vendorAddr1,$vendorAddr2,$vendorCity,$vendorState,$vendorZip,$vendorCountry,$vendorPhoneNbr1,$vendorPhoneNbr2,$vendorPhoneNbr3,$vendorFaxNbr1,$vendorFaxNbr2,$vendorEmail1,$VendorEmail2,$vendorWebpage1,$vendorWebpage2,$importDate);
					$vestmt->fetch();
					...
					if($importDate=="0000-00-00 00:00:00") $importDate="";
						...
						<table id="cmacctable<?php echo $veid; ?>" class="table table-striped table-bordered table-hover" style="clear: both">
							<tr>
								...
								<td><input type="text" value="<?php echo $capturis_vendor_id; ?>" class="veinputautosave" saveme="capturis_vendor_id"></td>
								<th width="15%">Vendor Name:</th>
								<td><input type="text" value="<?php echo $vendor_name; ?>" class="veinputautosave" saveme="vendor_name"></td>
								<th width="14%">Capturis Vendor Name:</th>
								<td><input type="text" value="<?php echo $capturis_vendor_name; ?>" class="veinputautosave" saveme="capturis_vendor_name"></td>
							</tr>

							<tr>
								<th width="14%">Vendor Abbreviation:</th>
								<td><input type="text" value="<?php echo $vendor_abbreviation; ?>" class="veinputautosave" saveme="vendor_abbreviation"></td>
								<th width="15%">Vendor Altname1:</th>
								<td><input type="text" value="<?php echo $vendor_altname1; ?>" class="veinputautosave" saveme="vendor_altname1"></td>
								<th width="14%">Vendor Altname2:</th>
								<td><input type="text" value="<?php echo $vendor_altname2; ?>" class="veinputautosave" saveme="vendor_altname2"></td>
							</tr>

							<tr>
								<th width="14%">Vendor Altname3:</th>
								<td><input type="text" value="<?php echo $vendor_altname3; ?>" class="veinputautosave" saveme="vendor_altname3"></td>
								<th width="15%">Vendor Altname4:</th>
								<td><input type="text" value="<?php echo $vendor_altname4; ?>" class="veinputautosave" saveme="vendor_altname4"></td>
								<th width="14%">Vendor Altname5:</th>
								<td><input type="text" value="<?php echo $vendor_altname5; ?>" class="veinputautosave" saveme="vendor_altname5"></td>
							</tr>
							...
							<tr>
								...
								<th width="15%">Service Group ID:</th>
								<td><input type="text" value="<?php echo $service_group_id; ?>" class="veinputautosave" saveme="service_group_id"></td>
								<th width="14%">Deregulated:</th>
								<td><input type="text" value="<?php echo $deregulated; ?>" class="veinputautosave" saveme="deregulated"></td>
							</tr>

							<tr>
								<th width="14%">Vendor Type:</th>
								<td><input type="text" value="<?php echo $vendor_type; ?>" class="veinputautosave" saveme="vendor_type"></td>
								<th width="15%">State:</th>
								<td><input type="text" value="<?php echo $state; ?>" class="veinputautosave" saveme="state"></td>
								<th width="14%">Vendor Address1:</th>
								<td><input type="text" value="<?php echo $vendorAddr1; ?>" class="veinputautosave" saveme="vendorAddr1"></td>
							</tr>

							<tr>
								<th width="14%">Vendor Address2:</th>
								<td><input type="text" value="<?php echo $vendorAddr2; ?>" class="veinputautosave" saveme="vendorAddr2"></td>
								<th width="15%">Vendor Fax Number1:</th>
								<td><input type="text" value="<?php echo $vendorFaxNbr1; ?>" class="veinputautosave" saveme="vendorFaxNbr1"></td>
								<th width="14%">Vendor Fax Number2:</th>
								<td><input type="text" value="<?php echo $vendorFaxNbr2; ?>" class="veinputautosave" saveme="vendorFaxNbr2"></td>
							</tr>

							<tr>
								<th width="14%">Vendor City:</th>
								<td><input type="text" value="<?php echo $vendorCity; ?>" class="veinputautosave" saveme="vendorCity"></td>
								<th width="15%">Vendor State:</th>
								<td><input type="text" value="<?php echo $vendorState; ?>" class="veinputautosave" saveme="vendorState"></td>
								<th width="14%">Vendor Zip:</th>
								<td><input type="text" value="<?php echo $vendorZip; ?>" class="veinputautosave" saveme="vendorZip"></td>
							</tr>

							<tr>
								<th width="14%">Vendor Country:</th>
								<td><input type="text" value="<?php echo $vendorCountry; ?>" class="veinputautosave" saveme="vendorCountry"></td>
								<th width="15%">Vendor Phone Number1:</th>
								<td><input type="text" value="<?php echo $vendorPhoneNbr1; ?>" class="veinputautosave" saveme="vendorPhoneNbr1"></td>
								<th width="14%">Vendor Phone Number2:</th>
								<td><input type="text" value="<?php echo $vendorPhoneNbr2; ?>" class="veinputautosave" saveme="vendorPhoneNbr2"></td>
							</tr>

							<tr>
								<th width="14%">Vendor Phone Number3:</th>
								<td><input type="text" value="<?php echo $vendorPhoneNbr3; ?>" class="veinputautosave" saveme="vendorPhoneNbr3"></td>
								<th width="15%">Vendor Email1:</th>
								<td><input type="text" value="<?php echo $vendorEmail1; ?>" class="veinputautosave" saveme="vendorEmail1"></td>
								<th width="14%">Vendor Email2:</th>
								<td><input type="text" value="<?php echo $VendorEmail2; ?>" class="veinputautosave" saveme="VendorEmail2"></td>
							</tr>


							<tr>
								<th width="14%">Vendor Webpage1:</th>
								<td><input type="text" value="<?php echo $vendorWebpage1; ?>" class="veinputautosave" saveme="vendorWebpage1"></td>
								<th width="15%">Vendor Webpage2:</th>
								<td><input type="text" value="<?php echo $vendorWebpage2; ?>" class="veinputautosave" saveme="vendorWebpage2"></td>
...
<?php } ?>
		...
		echo showlogs($veid,'vendor','vedetails','assets/ajax/vendor-pedit.php?action=details&veid='.$veid,$disabled);
		?>
	</div>
...
//$('.datetimepicker').datetimepicker();
  ...
  function autosave(savename,saveval){
	...
	$.ajax({
		type: 'post',
		url: 'assets/includes/vendor.inc.php',
		data: formData,
		processData: false,
		contentType: false,
...
$("#logshow").load("assets/ajax/showlogs.php?pkey=<?php echo $veid; ?>&tname=vendor&load=true&disb=<?php echo @trim($disabled); ?>&tuid=vedetails&tuurl=<?php echo urlencode('assets/ajax/vendor-pedit.php?action=details&veid='.$veid); ?>&ct=<?php echo rand(0,100); ?>");
					parent.$('#vetable').load("assets/ajax/vendor-pedit.php?load=true&ct=<?php mt_rand(2,77); ?>");
...
<table id="datatable_fixed_column" class="table table-striped table-bordered table-hover" width="100%">
	<thead>
			...
			<th class="hasinput">
				<input type="text" class="form-control" placeholder="Filter Deregulated" />
			</th>
			<th class="hasinput">
				<input type="text" class="form-control" placeholder="Filter Vendor City" />
			</th>
			<th class="hasinput">
				<input type="text" class="form-control" placeholder="Filter Vendor State" />
			</th>
			<th class="hasinput">
				<input type="text" class="form-control" placeholder="Filter Vendor Zip" />
			</th>
			<th class="hasinput">
				<input type="text" class="form-control" placeholder="Filter Vendor Country" />
			</th>
			<th class="hasinput">
		...
		<tr>
			<th data-hide="expand">Vendor ID</th>
			<th>Vendor Name</th>
			<th>Capturis Vendor Name</th>
			<th data-hide="phone">Service Group</th>
...
function veload_details(veid) {
	...
	$("#vedetails").load('assets/ajax/vendor-pedit.php?ct=<?php echo rand(0,100); ?>&action=details&veid='+veid);
	//otable.pageLength(6) ;
	//$("#ss_datatable_fixed_column").DataTable().page.len(6).draw();
}
function loadvemenu(veid) {
	veload_details(veid)
