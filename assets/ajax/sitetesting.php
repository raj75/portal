...
function load_details(id,cid) {
	...
	$('#sitesdetails').load('assets/ajax/sitedetailstesting.php?<?php if(isset($_GET["fromdashboard"])){ echo 'fromdashboard=true&'; } ?><?php if(isset($_GET["sid"])){?>noback=true&<?php } ?>id='+id+'&cid='+cid);
}

function load_sacc1(aids,sno,cid)
{
	...
	parent.$('#sitesaccountcont').load('assets/ajax/detailstesting.php?cid='+cid+'&pc=1&naids='+aids+'&sno='+sno+'');
}
...
{	//alert(arrparam);
	...
	parent.$('#sitesaccountcont').remove();
	parent.$('.siterow').after('<div id="sitesaccountcont" style="margin:0 !important;padding:0 !important;"></div>');
	parent.$('#sitesaccountcont').load('assets/ajax/detailstesting.php?cid='+cid+'&pc=1&naids='+aids+'&sno='+sno+'&params='+arrparam);
}
...
$(document).ready(function(){
	...
	$('#list-sites').load('assets/ajax/list-sitestesting.php?load=true&ct=<?php echo time(); echo $subquery; ?>');
	<?php } ?>
	...
	$('#hidedemo').change(function () {
		...
		$('#list-sites').load('assets/ajax/list-sitestesting.php?load=true&ct=<?php echo time(); ?>&showdemo='+showdemo);
	});
	<?php } ?>
});
</script>
