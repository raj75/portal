...
if(isset($_GET['accid']) and isset($_GET['action']) and $_GET['action'] == "details"){
	if(isset($_GET['accid']) and @trim($_GET['accid']) != "" and $_GET['accid'] > 0)
		$accid=$mysqli->real_escape_string(@trim($_GET['accid']));
	else
...
#wid-id--77 .nopadds{padding:0 !important;}
	...
	<div class="row ssse" id="<?php echo $accid; ?>">
		<!-- NEW WIDGET START -->
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id--77" data-widget-editbutton="false">
				<header>
					<span class="widget-icon"> <i class="fa fa-table"></i> </span>
					<h2>Rate ID: <?php echo $accid; ?></h2>
					<span class="widget-icon" style="float: right;padding-right: 24px;cursor:pointer;" onclick="clearme(<?php echo $accid; ?>,12,true,0)"> <i class="fa fa-times"></i> </span>
				</header>
				...
				if ($vestmt = $mysqli->prepare('Select ID,invoice_source,company_id,site_number,site_inactive_date,vendor_id,vendor_name,service_group_id,service_group,account_number1,account_number2,account_number3,legacy_account_number,service_point_location,name_key,account_active_date,account_inactive_date,meter_number,meter_active_date,meter_inactive_date,rate_id,activity_date,meter_status,gl_code,gl_reference,gl_group,notes,importDate From accounts Where ID='.$accid.' LIMIT 1')) {
				...
				if ($vestmt->num_rows > 0) {
					$vestmt->bind_result($accid,$invoice_source,$company_id,$site_number,$site_inactive_date,$vendor_id,$vendor_name,$service_group_id,$service_group,$account_number1,$account_number2,$account_number3,$legacy_account_number,$service_point_location,$name_key,$account_active_date,$account_inactive_date,$meter_number,$meter_active_date,$meter_inactive_date,$rate_id,$activity_date,$meter_status,$gl_code,$gl_reference,$gl_group,$notes,$importDate);
					$vestmt->fetch();

					$ts=$accid.rand(650,900);
					...
					if($importDate=="0000-00-00 00:00:00") $importDate="";
						?>
						<table id="cmacctable<?php echo $accid; ?>" class="table table-striped table-bordered table-hover" style="clear: both">
							<tr>
								<th width="14%">Invoice Source:</th>
								<td><input type="text" value="<?php echo $invoice_source; ?>" class="accinputautosave" saveme="rate_name"></td>
								<th width="15%">Company ID:</th>
								<td><?php echo $company_id; ?></td>
								<th width="14%">Site Number:</th>
								<td><?php echo $site_number; ?></td>
							</tr>

							<tr>
								<th width="14%">Site Inactive Date:</th>
								<td><input type="text" value="<?php echo $site_inactive_date; ?>" class="accinputautosave" saveme="site_inactive_date"></td>
								<th width="15%">Vendor Name:</th>
								<td><?php echo $vendor_name; ?></td>
								<th width="14%">Service Group:</th>
								<td><input type="text" value="<?php echo $service_group; ?>" class="accinputautosave" saveme="service_group"></td>
							</tr>

							<tr>
								<th width="14%">Account Number1:</th>
								<td><input type="text" value="<?php echo $account_number1; ?>" class="accinputautosave" saveme="account_number1"></td>
								<th width="15%">Account Number2:</th>
								<td><input type="text" value="<?php echo $account_number2; ?>" class="accinputautosave" saveme="account_number2"></td>
								<th width="14%">Account Number3:</th>
								<td><input type="text" value="<?php echo $account_number3; ?>" class="accinputautosave" saveme="account_number3"></td>
							</tr>

							<tr>
								<th width="14%">Legacy Account Number:</th>
								<td><input type="text" value="<?php echo $legacy_account_number; ?>" class="accinputautosave" saveme="legacy_account_number"></td>
								<th width="15%">Service Point Location:</th>
								<td><input type="text" value="<?php echo $service_point_location; ?>" class="accinputautosave" saveme="service_point_location"></td>
								<th width="14%">Name Key:</th>
								<td><input type="text" value="<?php echo $name_key; ?>" class="accinputautosave" saveme="name_key"></td>
							</tr>

							<tr>
								<th width="14%">Account Active Date:</th>
								<td><input type="text" value="<?php echo $account_active_date; ?>" class="accinputautosave" saveme="account_active_date"></td>
								<th width="15%">Account Inactive Date:</th>
								<td><input type="text" value="<?php echo $account_inactive_date; ?>" class="accinputautosave" saveme="account_inactive_date"></td>
								<th width="14%">Meter Number:</th>
								<td><input type="text" value="<?php echo $meter_number; ?>" class="accinputautosave" saveme="meter_number"></td>
							</tr>

							<tr>
								<th width="14%">Meter Active Date:</th>
								<td><input type="text" value="<?php echo $meter_active_date; ?>" class="accinputautosave" saveme="meter_active_date"></td>
								<th width="15%">Meter Inactive Date:</th>
								<td><input type="text" value="<?php echo $meter_inactive_date; ?>" class="accinputautosave" saveme="meter_inactive_date"></td>
								<th width="14%">Rate ID:</th>
								<td><input type="text" value="<?php echo $rate_id; ?>" class="accinputautosave" saveme="rate_id"></td>
							</tr>

							<tr>
								<th width="14%">Activity Date:</th>
								<td><input type="text" value="<?php echo $activity_date; ?>" class="accinputautosave" saveme="activity_date"></td>
								<th width="15%">Meter Status:</th>
								<td><input type="text" value="<?php echo $meter_status; ?>" class="accinputautosave" saveme="meter_status"></td>
								<th width="14%">GL Code:</th>
								<td><input type="text" value="<?php echo $gl_code; ?>" class="accinputautosave" saveme="gl_code"></td>
							</tr>

							<tr>
								<th width="14%">GL Reference:</th>
								<td><input type="text" value="<?php echo $gl_reference; ?>" class="accinputautosave" saveme="gl_reference"></td>
								<th width="15%">GL Group:</th>
								<td><input type="text" value="<?php echo $gl_group; ?>" class="accinputautosave" saveme="gl_group"></td>
								<th width="14%">ImportDate:</th>
								<td><input type="text" value="<?php echo $importDate; ?>" class="accinputautosave" saveme="importDate"></td>
							</tr>

							<tr>
								<th width="14%">Notes:</th>
								<td colspan=5><textarea rows="4" cols="50"  class="accinputautosave" saveme="notes"></textarea><?php echo $notes; ?></td>
							</tr>
<?php if(1==2){ ?>
							<tr>
								<th width="14%">Entity Name:</th>
								<td><input type="text" value="<?php echo $entity_name; ?>" class="accinputautosave" saveme="entity_name" <?php echo $disabled; ?>>
								<?php echo checkversionavailability($mysqli,"startstop_status",$ssid,"entity_name",$disabled); ?></td>
								<th width="15%">Tax ID:</th>
								<td><input type="text" value="<?php echo $federal_tax_id; ?>" class="accinputautosave" saveme="federal_tax_id" <?php echo $disabled; ?>>
								<?php echo checkversionavailability($mysqli,"startstop_status",$ssid,"federal_tax_id",$disabled); ?></td>
								<th width="14%">Site Number:</th>
								<td><input type="text" value="<?php echo $site_number; ?>" class="accinputautosave" saveme="site_number" <?php echo $disabled; ?>>
							...
							<tr>
								...
								<td><input type="text" value="<?php echo $utility_service_type; ?>" class="accinputautosave" saveme="utility_service_type" <?php echo $disabled; ?>>
								<?php echo checkversionavailability($mysqli,"startstop_status",$ssid,"utility_service_type",$disabled); ?></td>
								<th width="15%">Vendor Name:</th>
								<td><input type="text" value="<?php echo $vendor_name; ?>" class="accinputautosave" saveme="vendor_name" <?php echo $disabled; ?>>
								<?php echo checkversionavailability($mysqli,"startstop_status",$ssid,"vendor_name",$disabled); ?></td>
								<th width="14%">Site Name:</th>
								<?php ++$ts; ?>
								<td><input type="text" value="<?php echo $site_name; ?>" class="accinputautosave" saveme="site_name" <?php echo $disabled; ?>>
							...
							<tr>
								...
								<td><input type="text" value="<?php echo $date_requested; ?>" class="accinputautosave" saveme="date_requested" <?php echo $disabled; ?>>
								<?php echo checkversionavailability($mysqli,"startstop_status",$ssid,"date_requested",$disabled); ?></td>
								<th width="15%">Date Contacted:</th>
								<td><input type="text" value="<?php echo $date_contacted; ?>" class="accinputautosave" saveme="date_contacted" <?php echo $disabled; ?>>
								<?php echo checkversionavailability($mysqli,"startstop_status",$ssid,"date_contacted",$disabled); ?></td>
								<th width="14%">Contacted Method:</th>
								<td><input type="text" value="<?php echo $contacted_method; ?>" class="accinputautosave" saveme="contacted_method" <?php echo $disabled; ?>>
							...
							<tr>
								...
								<td><input type="text" value="<?php echo $previous_account_number; ?>" class="accinputautosave" saveme="previous_account_number" <?php echo $disabled; ?>>
								...
								<td><input type="text" value="<?php echo $account_number; ?>" class="accinputautosave" saveme="account_number" <?php echo $disabled; ?>>
								<?php echo checkversionavailability($mysqli,"startstop_status",$ssid,"account_number",$disabled); ?></td>
								<th width="14%">Meter:</th>
								<td><input type="text" value="<?php echo $meter; ?>" class="accinputautosave" saveme="meter" <?php echo $disabled; ?>>
...
<?php } ?>
		...
		echo showlogs($accid,'accounts','accdetails','assets/ajax/accounts-pedit.php?action=details&accid='.$accid,$disabled);
		?>
	</div>
...
//$('.datetimepicker').datetimepicker();
  $('.accinputautosave').blur(function() {
	 autosave($(this).attr("saveme"),$(this).val());
  });

  $('.accselectautosave').change(function() {
	 autosave($(this).attr("saveme"),$(this).val());
  });
  ...
  function autosave(savename,saveval){
	...
	formData.append('accauto', <?php echo $accid; ?>);
	formData.append('accsavename', savename);
	formData.append('accvalue', saveval);

	$.ajax({
		type: 'post',
		url: 'assets/includes/accounts.inc.php',
		data: formData,
		processData: false,
		contentType: false,
...
$("#logshow").load("assets/ajax/showlogs.php?pkey=<?php echo $accid; ?>&tname=accounts&load=true&disb=<?php echo @trim($disabled); ?>&tuid=accdetails&tuurl=<?php echo urlencode('assets/ajax/accounts-pedit.php?action=details&accid='.$accid); ?>&ct=<?php echo rand(0,100); ?>");
					parent.$('#acctable').load("assets/ajax/accounts-pedit.php?load=true&ct=<?php mt_rand(2,77); ?>");
...
<table id="datatable_fixed_column" class="table table-striped table-bordered table-hover" width="100%">
	<thead>
			...
			<th class="hasinput">
				<input type="text" class="form-control" placeholder="Filter Invoice Source" />
			</th>
			<th class="hasinput">
			...
			<th class="hasinput">
				<input type="text" class="form-control" placeholder="Filter Site Inactive Date" />
			</th>
			<th class="hasinput">
		...
		<tr>
			...
			<th>Company ID</th>
			<th data-hide="phone">Site Number</th>
	...
	var pagefunction = function() {
		...
		*/
		...
		/*"columnDefs": [
			...
			"autoWidth" : true,
			"ajax": "assets/ajax/server_processing_accounts.php"/*,
...
function accload_details(accid) {
	...
	$("#accdetails").load('assets/ajax/accounts-pedit.php?ct=<?php echo rand(0,100); ?>&action=details&accid='+accid);
	//otable.pageLength(6) ;
