...
$_COOKIE["docname"] = "Rate Optimization:Utility Rate Change Requests";
$_SESSION["docname"] = "Rate Optimization:Utility Rate Change Requests";
	...
	<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
		<h1 class="page-title txt-color-blueDark">
			<i class="glyphicon glyphicon-stats "></i>
				Rate Optimization <span>> Utility Rate Change Requests</span>
		</h1>
	</div>
</div>
<script>
