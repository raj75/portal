...
$_COOKIE["docname"] = "Energy Accounting:Ad Hoc Reports";
	...
	<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
		<h1 class="page-title txt-color-blueDark">
			<i class="glyphicon glyphicon-stats "></i> 
				Energy Accounting <span>> Ad Hoc Reports</span>
		</h1>
	</div>
</div>
...
<section id="widget-grid" class="">
	...
	?>
				...
				<?php
					...
					{
						?><iframe src="assets/plugins/cute-file-browsers/index.php?id=<?php echo rand(1,1000); ?>&docname=Energy Accounting:Ad Hoc Reports" frameborder="0" width="100%" height="100%" id="frame1"></iframe><?php
					}
				?>
				</div>
				<!-- end widget div -->
