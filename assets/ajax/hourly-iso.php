...
if(checkpermission($mysqli,59)==false) die("Permission Denied! Please contact Vervantis.");	
		...
		<?php } ?>
			...
			<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-2" data-widget-editbutton="false">
				...
				<header>
					...
					<h2>Locational Marginal Pricing </h2>
...
$(document).ready(function(){
	...
	$('#list-iso').load('assets/ajax/list-iso.php?load=true');
