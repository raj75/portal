...
if(checkpermission($mysqli,46)==false) die("Permission Denied! Please contact Vervantis.");

$user_one=$_SESSION['user_id'];
$cname=$_SESSION['company_id'];

$_COOKIE["docname"] = "Energy Procurement:Dynamic Risk Management";
$_SESSION["docname"] = "Energy Procurement:Dynamic Risk Management";
	...
	<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
		<h1 class="page-title txt-color-blueDark">
			<i class="glyphicon glyphicon-stats "></i>
				Energy Procurement <span>> Dynamic Risk Management</span>
		</h1>
	</div>
</div>
<script>
