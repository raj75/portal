...
if(checkpermission($mysqli,33)==false) die("Permission Denied! Please contact Vervantis.");

$user_one=$_SESSION['user_id'];
$cname=$_SESSION['company_id'];

$_COOKIE["docname"] = "Data Management:Data Analysis";
$_SESSION["docname"] = "Data Management:Data Analysis";
	...
	<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
		<h1 class="page-title txt-color-blueDark">
			<i class="glyphicon glyphicon-stats "></i>
				Data Management <span>> Data Analysis</span>
		</h1>
	</div>
</div>
<script>
