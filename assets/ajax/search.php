...
if(isset($_GET["params"]) and @trim($_GET["params"]) != "")
	$searchwords=$_GET["params"];
else
	$searchwords="";
?>
<div class="row">
	...
	<div class="col-sm-12">
		...
		<div id="myTabContent1" class="tab-content bg-color-white padding-10">
			<div class="tab-pane fade in active" id="s1">
				...
				<h1 class="font-md" id="search-all"> Search Results for <span class="semi-bold">All</span><small class="text-danger"> &nbsp;&nbsp;(2,281 results)</small></h1>
			...
			<div class="tab-pane fade" id="s2">
				...
				<h1 class="font-md" id="usersearch"> Search Results for <span class="semi-bold">Users</span><small class="text-danger"> &nbsp;&nbsp;(181 results)</small></h1>
				<br>
				<div class="table-responsive">
					...
					<table id="resultTable" class="table table-striped table-bordered table-hover">
						...
						<tbody>
							...
							<tr>
								<td><img src="assets/img/avatars/male.png" alt=""  width="20"></td><td>Clyde</td><td>Hudson</td><td>2008-08-22</td><td>elvia@smilesmoke.info <a href="javascript:void(0);" class="pull-right"><i class="fa fa-key"></i></a></td><td>Sunset</td><td>88755</td><td>561-388-1897</td><td><span class="label label-success">Active</span></td>
							</tr>
...
function searchdata(searchkey)
{
	if(searchkey == "")
		...
		$.ajax({
			url: 'assets/includes/search.inc.php',
			type: 'GET',
			...
			success: function (data) {
			  if(data != false)
			  {
				...
				if(result.blogsearch.length > 0)
				{
					for (i = 0; i < result.blogsearch.length; i++) { 
						$("#search-all").after('<div class="search-results clearfix smart-form"><h4><i class="fa fa-plus-square txt-color-blue"></i>&nbsp;<a href="javascript:void(0);">'+result.blogsearch[i].title+'</a></h4><div><div class="url text-success">http://www.wrapbootstrap.com <i class="fa fa-caret-down"></i></div><p class="description">'+result.blogsearch[i].body+'</p></div></div>');
					}
				}
			  }else{
				alert("Error");
