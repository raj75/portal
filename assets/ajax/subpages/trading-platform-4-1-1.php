...
<style>
#datatable_fixed_column4-1-1<?php echo $ttrand; ?>_filter, #datatable_fixed_column4-1-1<?php echo $ttrand; ?>-4_filter,.dataTables_filter{
float: left;
...
#datatable_fixed_column4-1-1<?php echo $ttrand; ?>_length,#datatable_fixed_column4-1-1<?php echo $ttrand; ?>-4_length,.dataTables_length{
float: right !important;
margin: 1% 1% !important;
}
...
#datatable_fixed_column4-1-1<?php echo $ttrand; ?>,#datatable_fixed_column4-1-1<?php echo $ttrand; ?>-4,.innerdtable{border-bottom: 1px solid #ccc !important;}}
#datatable_fixed_column4-1-1<?php echo $ttrand; ?> option,#datatable_fixed_column4-1-1<?php echo $ttrand; ?>-4 option,.innerdtable option {
  color: #555;
}
#datatable_fixed_column4-1-1<?php echo $ttrand; ?> tr.dropdown select, #datatable_fixed_column4-1-1<?php echo $ttrand; ?>-4  tr.dropdown select,.innerdtable  tr.dropdown select{font-weight: 400 !important;}
			...
			<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-2<?php echo $ttrand; ?>" data-widget-editbutton="false">
				...
				<div>
					...
					<div class="widget-body no-padding">
						<table id="datatable_fixed_column4-1-1<?php echo $ttrand; ?>" class="table table-striped table-bordered table-hover" width="100%">
							<thead>
								<tr class="dropdown">
...
<?php
	//$sqlin='SELECT a.`code`,a.date,a.settlement FROM ICE.AR_MWIS a WHERE a.code IN ('.implode(",",$tempccarr).') ORDER BY a.date DESC';
...
<script type="text/javascript">
	...
	var pagefunction = function() {
		...
		/* COLUMN FILTER  */
			var otable<?php echo $ttrand; ?> = $("#datatable_fixed_column4-1-1<?php echo $ttrand; ?>").DataTable( {
	    ...
	    // Apply the filter
	    $("#datatable_fixed_column4-1-1<?php echo $ttrand; ?> thead th input[type=text]").on( 'keyup change', function () {
	...
	{
		var items=[], options=[];
		$('#datatable_fixed_column4-1-1<?php echo $ttrand; ?> tbody tr td:nth-child('+indexno+')').each( function(){
...
<?php
}elseif(isset($_GET["req"]) and $_GET["req"]=="innerschart" and isset($_GET["cc"]) and !empty($_GET["cc"])){
	$clearingcode=@trim($_GET["cc"]);
	$ttrand=rand(20,500)."r".rand(20,500);
	$tmp_arr=$tmpccarr=$tempccarr=array();
	$tmpccarr=@explode(",",$clearingcode);
