...
if(isset($_GET['litid']) and isset($_GET['action']) and $_GET['action'] == "details"){
	if(isset($_GET['litid']) and @trim($_GET['litid']) != "" and $_GET['litid'] > 0)
		$litid=$mysqli->real_escape_string(@trim($_GET['litid']));
	else
...
#wid-id--77 .nopadds{padding:0 !important;}
	...
	<div class="row ssse" id="<?php echo $litid; ?>">
		<!-- NEW WIDGET START -->
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id--77" data-widget-editbutton="false">
				<header>
					<span class="widget-icon"> <i class="fa fa-table"></i> </span>
					<h2>ID: <?php echo $litid; ?></h2>
					<span class="widget-icon" style="float: right;padding-right: 24px;cursor:pointer;" onclick="clearme(<?php echo $litid; ?>,12,true,0)"> <i class="fa fa-times"></i> </span>
				</header>
				...
				if ($vestmt = $mysqli->prepare('Select ID,service_group_id,service_group,line_item_description,TOU,`Type`,Season,Demand,Reactive,PFactor,Billed,Losses,Coincident,Bundled,importDate From line_item_tou Where ID='.$litid.' LIMIT 1')) {

				$vestmt->execute();
				$vestmt->store_result();
				if ($vestmt->num_rows > 0) {
					$vestmt->bind_result($litid,$service_group_id,$service_group,$line_item_description,$TOU,$_Type,$Season,$Demand,$Reactive,$PFactor,$Billed,$Losses,$Coincident,$Bundled,$importDate);
					$vestmt->fetch();

					$ts=$litid.rand(650,900);
					...
					if($importDate=="0000-00-00 00:00:00") $importDate="";
						?>
						<table id="cmacctable<?php echo $litid; ?>" class="table table-striped table-bordered table-hover" style="clear: both">
							<tr>
								<th width="14%">Service Group:</th>
								<td><?php echo $service_group; ?></td>
								<th width="15%">Line Item Description:</th>
								<td><input type="text" value="<?php echo $line_item_description; ?>" class="litinputautosave" saveme="line_item_description"></td>
								<th width="14%">Import Date:</th>
								<td><input type="text" value="<?php echo $importDate; ?>" class="litinputautosave" saveme="importDate"></td>
							</tr>

							<tr>
								<th width="14%">TOU:</th>
								<td><input type="text" value="<?php echo $TOU; ?>" class="litinputautosave" saveme="TOU"></td>
								<th width="15%">Type:</th>
								<td><input type="text" value="<?php echo $_Type; ?>" class="litinputautosave" saveme="Type"></td>
								<th width="14%">Season:</th>
								<td><input type="text" value="<?php echo $Season; ?>" class="litinputautosave" saveme="Season"></td>
							</tr>

							<tr>
								<th width="14%">Demand:</th>
								<td><input type="text" value="<?php echo $Demand; ?>" class="litinputautosave" saveme="Demand"></td>
								<th width="15%">Reactive:</th>
								<td><input type="text" value="<?php echo $_Type; ?>" class="litinputautosave" saveme="Reactive"></td>
								<th width="14%">PFactor:</th>
								<td><input type="text" value="<?php echo $PFactor; ?>" class="litinputautosave" saveme="PFactor"></td>
							</tr>

							<tr>
								<th width="14%">Billed:</th>
								<td><input type="text" value="<?php echo $Billed; ?>" class="litinputautosave" saveme="Billed"></td>
								<th width="15%">Losses:</th>
								<td><input type="text" value="<?php echo $Losses; ?>" class="litinputautosave" saveme="Losses"></td>
								<th width="14%">Coincident:</th>
								<td><input type="text" value="<?php echo $Coincident; ?>" class="litinputautosave" saveme="Coincident"></td>
							</tr>

							<tr>
								<th width="14%">Bundled:</th>
								<td><input type="text" value="<?php echo $Bundled; ?>" class="litinputautosave" saveme="Bundled"></td>
								<th width="15%"></th>
								<td></td>
								<th width="14%"></th>
								<td></td>
...
<?php if(1==2){ ?>
							<tr>
								...
								<td><input type="text" value="<?php echo $entity_name; ?>" class="litinputautosave" saveme="entity_name" <?php echo $disabled; ?>>
								<?php echo checkversionavailability($mysqli,"startstop_status",$ssid,"entity_name",$disabled); ?></td>
								<th width="15%">Tax ID:</th>
								<td><input type="text" value="<?php echo $federal_tax_id; ?>" class="litinputautosave" saveme="federal_tax_id" <?php echo $disabled; ?>>
								<?php echo checkversionavailability($mysqli,"startstop_status",$ssid,"federal_tax_id",$disabled); ?></td>
								<th width="14%">Site Number:</th>
								<td><input type="text" value="<?php echo $site_number; ?>" class="litinputautosave" saveme="site_number" <?php echo $disabled; ?>>
							...
							<tr>
								...
								<td><input type="text" value="<?php echo $utility_service_type; ?>" class="litinputautosave" saveme="utility_service_type" <?php echo $disabled; ?>>
								...
								<td><input type="text" value="<?php echo $vendor_name; ?>" class="litinputautosave" saveme="vendor_name" <?php echo $disabled; ?>>
								<?php echo checkversionavailability($mysqli,"startstop_status",$ssid,"vendor_name",$disabled); ?></td>
								<th width="14%">Site Name:</th>
								<?php ++$ts; ?>
								<td><input type="text" value="<?php echo $site_name; ?>" class="litinputautosave" saveme="site_name" <?php echo $disabled; ?>>
							...
							<tr>
								...
								<td><input type="text" value="<?php echo $date_requested; ?>" class="litinputautosave" saveme="date_requested" <?php echo $disabled; ?>>
								<?php echo checkversionavailability($mysqli,"startstop_status",$ssid,"date_requested",$disabled); ?></td>
								<th width="15%">Date Contacted:</th>
								<td><input type="text" value="<?php echo $date_contacted; ?>" class="litinputautosave" saveme="date_contacted" <?php echo $disabled; ?>>
								<?php echo checkversionavailability($mysqli,"startstop_status",$ssid,"date_contacted",$disabled); ?></td>
								<th width="14%">Contacted Method:</th>
								<td><input type="text" value="<?php echo $contacted_method; ?>" class="litinputautosave" saveme="contacted_method" <?php echo $disabled; ?>>
							...
							<tr>
								...
								<td><input type="text" value="<?php echo $previous_account_number; ?>" class="litinputautosave" saveme="previous_account_number" <?php echo $disabled; ?>>
								...
								<td><input type="text" value="<?php echo $account_number; ?>" class="litinputautosave" saveme="account_number" <?php echo $disabled; ?>>
								<?php echo checkversionavailability($mysqli,"startstop_status",$ssid,"account_number",$disabled); ?></td>
								<th width="14%">Meter:</th>
								<td><input type="text" value="<?php echo $meter; ?>" class="litinputautosave" saveme="meter" <?php echo $disabled; ?>>
...
<?php } ?>
		...
		echo showlogs($litid,'line_item_tou','litdetails','assets/ajax/line-item-tou-pedit.php?action=details&litid='.$litid,$disabled);
		?>
	</div>
...
//$('.datetimepicker').datetimepicker();
  $('.litinputautosave').blur(function() {
	 autosave($(this).attr("saveme"),$(this).val());
  });

  $('.litselectautosave').change(function() {
	 autosave($(this).attr("saveme"),$(this).val());
  });
  ...
  function autosave(savename,saveval){
	...
	formData.append('litauto', <?php echo $litid; ?>);
	formData.append('litsavename', savename);
	formData.append('litvalue', saveval);

	$.ajax({
		type: 'post',
		url: 'assets/includes/lineitemtou.inc.php',
		data: formData,
		processData: false,
		contentType: false,
...
$("#logshow").load("assets/ajax/showlogs.php?pkey=<?php echo $litid; ?>&tname=line_item_tou&load=true&disb=<?php echo @trim($disabled); ?>&tuid=vedetails&tuurl=<?php echo urlencode('assets/ajax/line-item-tou-pedit.php?action=details&litid='.$litid); ?>&ct=<?php echo rand(0,100); ?>");
					parent.$('#littable').load("assets/ajax/line-item-tou-pedit.php?load=true&ct=<?php mt_rand(2,77); ?>");
...
<table id="datatable_fixed_column" class="table table-striped table-bordered table-hover" width="100%">
	<thead>
			...
			<th class="hasinput">
				<input type="text" class="form-control" placeholder="Filter Service Group ID" />
			</th>
			<th class="hasinput">
			...
			<th class="hasinput">
				<input type="text" class="form-control" placeholder="Filter Season" />
			</th>
			<th class="hasinput">
				<input type="text" class="form-control" placeholder="Filter Demand" />
			</th>
			<th class="hasinput">
				<input type="text" class="form-control" placeholder="Filter Reactive" />
			</th>
			<th class="hasinput">
				<input type="text" class="form-control" placeholder="Filter PFactor" />
			</th>
			<th class="hasinput">
				<input type="text" class="form-control" placeholder="Filter Billed" />
			</th>
			<th class="hasinput">
				<input type="text" class="form-control" placeholder="Filter Losses" />
			</th>
			<th class="hasinput">
				<input type="text" class="form-control" placeholder="Filter Coincident" />
			</th>
			<th class="hasinput">
		...
		<tr>
			...
			<th>Service Group ID</th>
			<th>Service Group</th>
			<th data-hide="phone">Line Item Description</th>
			<th data-hide="phone,tablet">TOU</th>
			<th>Type</th>
			<th>Season</th>
			<th>Demand</th>
			<th>Reactive</th>
	...
	var pagefunction = function() {
		...
		*/
		...
		/*"columnDefs": [
			...
			"autoWidth" : true,
			"ajax": "assets/ajax/server_processing_lineitemtou.php"/*,
...
function litload_details(litid) {
	...
	$("#litdetails").load('assets/ajax/line-item-tou-pedit.php?ct=<?php echo rand(0,100); ?>&action=details&litid='+litid);
	//otable.pageLength(6) ;
	//$("#ss_datatable_fixed_column").DataTable().page.len(6).draw();
}
function loadlitmenu(litid) {
	litload_details(litid)
