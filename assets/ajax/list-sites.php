	...
	var pagefunction = function() {
		...
		*/
		...
		'columns': [
			 ...
			 {data:'state'},
			 {data:'postal_code'},
			 {data:'site_status'}, // dont change order of these columns and site_status should be on index 8 see in server_processing page
        ...
        "language": {
			...
			"autoWidth" : true,
			"deferRender": true,
			"ajax": "assets/ajax/server_processing.php<?php echo $subquery; ?>",
			'serverMethod': 'post',
	    });
		...
		//--------------------------------------------------------------------
			...
			var undo_editor = new $.fn.dataTable.Editor( {
					ajax: 'assets/ajax/sites-undo-save.php',
					table: '#undo_delete',
					...
					undo_table = $('#undo_delete').DataTable({
						...
						*/
						...
						"language": {
							...
							"autoWidth" : true,
							"ajax": "assets/ajax/sites-deleted.php",
							'serverMethod': 'post',
						  'select': {
							 'style': 'multi'
						  },
