...
if(($_SESSION["group_id"]==5 or $_SESSION["group_id"]==1) and isset($_GET["userpermission"])){
	...
	$_ppdisabled_menu=array();
		if($_SESSION["group_id"]==1 || $_SESSION["group_id"]==2){
			$sql='SELECT ui.custom_interface,u.usergroups_id,u.company_id FROM users_interface ui, user u where ui.user_id=u.user_id and u.user_id="'.$_userid.'" LIMIT 1';

//SELECT ui.custom_interface,u.usergroups_id,u.company_id FROM users_interface ui, user u where ui.user_id=u.id and u.id="'.$_userid.'" LIMIT 1';
...
//'SELECT ui.custom_interface,u.usergroups_id,u.company_id FROM users_interface ui, user u where (u.usergroups_id = 5 OR u.usergroups_id = 3) and ui.user_id=u.id and ui.user_id="'.$_userid.'" and u.company_id=(SELECT usp.company_id FROM user usp WHERE usp.id= "'.$user_one.'") LIMIT 1';
		...
		<table cellpadding="5">
			  <tr>
				 ...
				 <?php }elseif(!in_array(1,$_pdisabled_menu_a_arr)){ ?>
					<input type="checkbox" name="pu" value="1" <?php if(!in_array(1,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(48,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="48" <?php if(!in_array(48,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(59,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="59" <?php if(!in_array(59,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
			  </tr>
			  <tr>
				<td>Live Weather</td>
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(52,$_pdisabled_menu_a_arr)){ ?>
				<td><input type="checkbox" name="pu" value="52" <?php if(!in_array(52,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
			  </tr>
			  <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(60,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="60" <?php if(!in_array(60,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
			  </tr>
			  <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(2,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="2" <?php if(!in_array(2,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
			  </tr>
			  <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(3,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="3" <?php if(!in_array(3,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
			  </tr>
			  </table>
		</article>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(31,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="31" <?php if(!in_array(31,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
		  </tr>
		  <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(42,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="42" <?php if(!in_array(42,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
		  </tr>
		  <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(46,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="46" <?php if(!in_array(46,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
		  </tr>
		  <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(54,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="54" <?php if(!in_array(54,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
		  </tr>
		  <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(55,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="55" <?php if(!in_array(55,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
		  </tr>
		  <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(56,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="56" <?php if(!in_array(56,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
		  </tr>
		  </table>
		</article>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(30,$_pdisabled_menu_a_arr)){ ?>
				<td><input type="checkbox" name="pu" value="30" <?php if(!in_array(30,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
			  </tr>
			  <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(41,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="41" <?php if(!in_array(41,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
			  </tr>
			  <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(61,$_pdisabled_menu_a_arr)){ ?>
				<td><input type="checkbox" name="pu" value="61" <?php if(!in_array(61,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
			  </tr>
			  </table>
		</article>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(49,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="49" <?php if(!in_array(49,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
      <tr>
		<td>Stop Service</td>
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(50,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="50" <?php if(!in_array(50,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
      <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(51,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="51" <?php if(!in_array(51,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
      <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(58,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="58" <?php if(!in_array(58,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
	  </table>
		</article>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(35,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="35" <?php if(!in_array(35,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
      <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(37,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="37" <?php if(!in_array(37,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
      <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(36,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="36" <?php if(!in_array(36,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
      <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(62,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="62" <?php if(!in_array(62,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
      <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(63,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="63" <?php if(!in_array(63,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
      <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(64,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="64" <?php if(!in_array(64,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
	  </table>
		</article>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(33,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="33" <?php if(!in_array(33,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
      <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(65,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="65" <?php if(!in_array(65,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
      <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(34,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="34" <?php if(!in_array(34,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
	  </table>
		</article>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(38,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="38" <?php if(!in_array(38,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
      <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(39,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="39" <?php if(!in_array(39,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
      <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(74,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="74" <?php if(!in_array(74,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
      <tr>
		<td>Surveys</td>
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(75,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="75" <?php if(!in_array(75,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
	  </table>
		</article>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(40,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="40" <?php if(!in_array(40,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
      <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(66,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="66" <?php if(!in_array(66,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
      <tr>
		<td>EV Charging</td>
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(67,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="67" <?php if(!in_array(67,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
      <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(68,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="68" <?php if(!in_array(68,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
      <tr>
		<td>Other</td>
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(69,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="69" <?php if(!in_array(69,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
	  </table>
		</article>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(45,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="45" <?php if(!in_array(45,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
      <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(17,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="17" <?php if(!in_array(17,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
      <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(6,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="6" <?php if(!in_array(6,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
      <tr>
		<td>Focus Items</td>
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(5,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="5" <?php if(!in_array(5,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
	  </table>
		</article>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(9,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="9" <?php if(!in_array(9,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
	  </table>
		</article>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(12,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="12" <?php if(!in_array(12,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
      <tr>
...
<?php if($_SESSION["group_id"]==1){?>
 ...
 <?php }elseif(!in_array(13,$_pdisabled_menu_a_arr)){ ?>
			<td><input type="checkbox" name="pu" value="13" <?php if(!in_array(13,$_pdisabled_menu_c_arr)) echo 'checked';?>></td>
 <?php }else echo "<td><span class='redc'>(No Access)</span></td>"; ?>
      </tr>
<?php if(1==2){?>
      <tr>
