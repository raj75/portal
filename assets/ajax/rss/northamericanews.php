...
if ($ckmainstmt = mysqli_query($conn,"SELECT id,title,image,description,url,published_date,logo FROM ".$tablename." WHERE newstype='NorthAmerica' order by published_date desc LIMIT 0,63")) {
