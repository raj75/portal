...
if(checkpermission($mysqli,65)==false) die("Permission Denied! Please contact Vervantis.");

$user_one=$_SESSION['user_id'];
$cname=$_SESSION['company_id'];

$_COOKIE["docname"] = "Data Management:Consumption Reports";
$_SESSION["docname"] = "Data Management:Consumption Reports";
	...
	<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
		<h1 class="page-title txt-color-blueDark">
			<i class="glyphicon glyphicon-stats "></i>
				Data Management <span>> Consumption Reports</span>
		</h1>
	</div>
</div>
<script>
