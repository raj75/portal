...
if(checkpermission($mysqli,129)==false) die("Permission Denied! Please contact Vervantis.");
	...
	<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
		<h1 class="page-title txt-color-blueDark">
			<i class="fa fa-table"></i>
				Reports <span>> Cost and Usage Report</span>
		</h1>
		...
		<section id="widget-grid2" class="sitestable m-top45 ">
				...
				<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-editbutton="false">
					...
					<div class="row myrow">
						...
						<form type="POST" name="fprocess" id="fprocessForm" class="smart-form-- toffform--">
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
						  ...
						  <div class="row myrow">
							...
							<div class="myfilter">
								...
								<label class="toggle tofflabel">
									<input type="checkbox" name="show_meter" value="1" class="toffinputacc" >
									<i data-swchon-text="ON" data-swchoff-text="OFF" class="toffcheck"></i>Meter
								</label>
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
							...
							<div class="" style="padding-left:15px; float:left">
								...
								<button onclick="navigateurl('assets/ajax/framework_cost_usage_report.php','Accounts Report')" type="button" class="btn btn-default" id="reset_query">Reset</button> 
							</div>
						</div>
...
<script type="text/javascript">
	...
	var pagefunction = function() {
		...
		flf_table = new DataTable('#flf_datatable', {
			...
			ajax: {
				url: 'assets/ajax/framework_cost_usage_report_ajax.php',
				data: function (d) {
					var meter_val = $('input[name="show_meter"]:checked').val();
					//console.log("meter_val=="+meter_val);
					//var meter_column = flf_table.column(9);	
			...
			*/
			...
			initComplete: function (settings, json) {
				var meter_column_int = flf_table.column(9);				
				meter_column_int.visible(false);
				
				
				<?php if ($_SESSION["group_id"] == 1 OR $_SESSION["group_id"] == 2) { ?>
				flf_table.column( 0 ).visible( true );				
				<?php } ?>
				//$('[data-cv-idx="3"]').hide();
	...
	$(document).ready(function(){
		...
		*/
		  ...
		  $('#create_query').on('click', function () {
			...
			*/
			...
			flf_table.column(13).search( start_end_date ); // entry date
			...
			*/
			...
			if (state_ar.length > 0) {
				flf_table.column(5).search( state_ar ); // state
			} else {
				flf_table.column(5).search(""); // state
			}
			...
			// check if site set 
			if (site_id.length > 0) {
				flf_table.column(1).search( site_id ); // site
			} else {
				flf_table.column(1).search(""); // site
			}
			
			//show hide meter number
			
			var show_meter = $('input[name="show_meter"]:checked').val();
			var meter_column = flf_table.column(10);	
			if (show_meter == 1) {				
				meter_column.visible(true);
				//let columnIdx = e.target.getAttribute('data-column');
				//var column_datatable = flf_table.column(columnIdx); 
				// Toggle the visibility
				//column.visible(!column.visible());
			} else {
				meter_column.visible(false);
			}
		...
		*/
		...
		$(document).on("click","#flf_datatable tbody tr",function() {
			...
			var dt_invoice_id = flf_table.row(this).data().Invoices;
		...
		*/
		...
		$('#group_by').on('change', function (e) {
			...
			if (group_option == 'none') {
				...
				if (group_option == 'Account_Number') {
					order_ind = 8;
