...
$_COOKIE["docname"] = "Rate Optimization:Regulated Information";
$_SESSION["docname"] = "Rate Optimization:Regulated Information";
	...
	<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
		<h1 class="page-title txt-color-blueDark">
			<i class="glyphicon glyphicon-stats "></i>
				Rate Optimization <span>> Regulated Information</span>
		</h1>
	</div>
</div>
<script>
