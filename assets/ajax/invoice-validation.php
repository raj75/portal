...
$_COOKIE["docname"] = "Energy Accounting:Invoice Validation";
$_SESSION["docname"] = "Energy Accounting:Invoice Validation";
	...
	<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
		<h1 class="page-title txt-color-blueDark">
			<i class="glyphicon glyphicon-stats "></i>
				Energy Accounting <span>> Invoice Validation</span>
		</h1>
	</div>
</div>
<script>
