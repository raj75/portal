...
if(checkpermission($mysqli,39)==false) die("Permission Denied! Please contact Vervantis.");

$user_one=$_SESSION['user_id'];
$cname=$_SESSION['company_id'];

$_COOKIE["docname"] = "Sustainability:Sustainability Reports";
$_SESSION["docname"] = "Sustainability:Sustainability Reports";
	...
	<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
		<h1 class="page-title txt-color-blueDark">
			<i class="glyphicon glyphicon-stats "></i>
				Sustainability <span>> Sustainability Reports</span>
		</h1>
	</div>
</div>
<script>
