							...
							<table id="ei_datatable_fixed_column" class="table table-striped table-bordered table-hover" width="100%">
								<thead>
									...
									<tr>
										...
										<th class="hasinput">
											<input type="text" class="form-control" placeholder="Filter Inbox" />
										</th>
										<th class="hasinput">
											<input type="text" class="form-control" placeholder="Filter Notification Schedule" />
										</th>
										<th class="hasinput">
											<input type="text" class="form-control" placeholder="Filter Banking Information?" />
										</th>
										<th class="hasinput">
											<input type="text" class="form-control" placeholder="Filter Receiver" />
										</th>
										<th class="hasinput">
									...
									<tr>
										...
										<th data-hide="phone,tablet">Inbox </th>
										<th data-hide="phone,tablet">Notification Schedule </th>
										<th data-hide="phone,tablet">Banking Information? </th>
			...
			*/
			...
			/* BASIC ;*/
				...
				var editor = new $.fn.dataTable.Editor( {
					ajax: 'assets/ajax/payment-notifications-save.php',
			...
			/* COLUMN FILTER  */
				var otable = $("#ei_datatable_fixed_column").DataTable( {
					...
					'serverMethod': 'post',
					'ajax': {
					   'url':'/assets/ajax/payment-notification-ajax.php'
					},
