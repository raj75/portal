...
;(function($){
	...
	$.fn.rangePicker.defaults = {
		...
		closeOnSelect : true,
		presets : [{
				buttonText  : '12 month strip',
				displayText : '12 month strip',
				value       : '12'
			},{
				buttonText  : '24 month strip',
				displayText : '24 month strip',
				value       : '24'
			},{
				buttonText  : '36 month strip',
				displayText : '36 month strip',
				value       : '36'
			},{
				buttonText  : 'Custom',
